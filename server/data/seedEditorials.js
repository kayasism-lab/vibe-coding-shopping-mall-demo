module.exports = [
  {
    ...
    intro:
      "이번 시즌의 셀렉션은 오래 남는 실루엣과 절제된 텍스처를 중심으로 구성했습니다. 지나치게 많은 장식 대신 소재와 라인의 균형이 브랜드의 태도를 설명합니다.",
    eventBlocks: [
      {
        eyebrow: "Edit 01",
    ...
    manifestoSections: [
      {
        ...
        body: "어깨선과 소매 볼륨을 정제해 단순하지만 힘 있는 인상을 만들었습니다. 무채색 팔레트 안에서도 소재 차이만으로 충분한 리듬이 생기도록 설계했습니다.",
        image:
          "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?q=80&w=2574&auto=format&fit=crop",
        imageAlt: "미니멀한 실루엣의 코트 스타일링",
      },
      {
        heading: "Material Before Decoration",
        body: "표면감이 좋은 울, 부드러운 블라우스, 오래 사용할 수 있는 가죽 액세서리로 시각적 완성도를 높였습니다. 포인트는 디테일보다 질감에서 나옵니다.",
        image:
          "https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=2670&auto=format&fit=crop",
        imageAlt: "소재 중심의 미니멀 스타일 디테일",
      },
    ],
    looks: [],
    processSections: [],
  ...
  },
  {
    ...
    intro:
      "봄 시즌은 겹쳐 입기 좋은 가벼운 아이템과 적당한 긴장감을 주는 구조적인 제품 사이의 균형에서 시작합니다. 각 룩은 실용성과 브랜드 무드를 동시에 보여주도록 구성했습니다.",
    eventBlocks: [
      {
        eyebrow: "Look 01",
        title: "Layered Start",
    ...
    looks: [
      {
        title: "Morning Layer",
        body: "실크 블렌드 블라우스와 테일러드 팬츠를 조합해 부드럽지만 정돈된 출근 룩을 제안합니다.",
        image:
          "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=2640&auto=format&fit=crop",
        imageAlt: "블라우스와 팬츠를 활용한 봄 스타일링",
        linkedSkus: [2, 3],
      },
      {
        title: "Soft Weekend",
        body: "린넨 드레스 하나로 완성되는 주말 룩은 움직임이 가볍고 사진으로도 분위기가 잘 살아납니다.",
        image:
          "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?q=80&w=2576&auto=format&fit=crop",
        imageAlt: "린넨 드레스를 활용한 주말 스타일링",
        linkedSkus: [7],
      },
    ],
    processSections: [],
  ...
  },
  {
    ...
    intro:
      "한 장의 메인 비주얼이 만들어지기 전에는 제품 선택, 톤 조율, 촬영 동선 설계 같은 작은 결정들이 반복됩니다. 이번 페이지는 그 준비 과정을 하나의 브랜드 스토리로 보여줍니다.",
    eventBlocks: [
      {
        eyebrow: "Studio 01",
    ...
    processSections: [
      {
        ...
        body: "촬영 전날에는 제품의 소재감과 컬러 밸런스를 테이블 위에서 다시 확인합니다. 같은 베이지라도 광택과 질감이 다르기 때문에 실물 조합이 중요합니다.",
        image:
          "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?q=80&w=2574&auto=format&fit=crop",
        imageAlt: "촬영 전 상품을 고르는 장면",
      },
      {
        heading: "Frame and Flow",
        body: "룩이 가진 움직임을 살리기 위해 세트는 최대한 간결하게 두고, 피사체와 제품이 자연스럽게 드러나도록 동선을 단순화합니다.",
        image:
          "https://images.unsplash.com/photo-1496747611176-843222e1e57c?q=80&w=2573&auto=format&fit=crop",
        imageAlt: "스튜디오 촬영 현장의 움직임",
      },
    ],
    galleryImages: [
      {
